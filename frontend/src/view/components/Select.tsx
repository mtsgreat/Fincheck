...
export function Select({ className, placeholder, options,  error } :SelectProps){
   ...
   <div>
      <div className="relative">
        ...
        <RdxSelect.Root onValueChange={handleSelect}>
            <RdxSelect.Trigger
                className={cn(
                    'bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 transition-all outline-none text-left relative pt-4',
